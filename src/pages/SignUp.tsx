  ...
  return (
    <AuthLayout title="Register" subtitle="Create your StudyConnect account">
      <div className="d-flex flex-column gap-3">
        ...
        <div className="row g-2">
          <div className="col-12 col-sm-4">
            <SocialButton provider="google" onClick={loginWithGoogle}>
              <svg className="bi" width="16" height="16" viewBox="0 0 533.5 544.3"><path fill="#4285F4" d="M533.5 278.4c0-18.3-1.5-36.1-4.4-53.3H272.1v100.9h147.1c-6.3 34.1-25 63-53.5 82.5v68h86.4c50.6-46.7 81.4-115.3 81.4-198.1z" /></svg>
              Google
            </SocialButton>
          </div>
          <div className="col-12 col-sm-4">
        ...
        {showPhone && <PhoneOtpModal onClose={() => setShowPhone(false)} onLoggedIn={(token) => { localStorage.setItem('sc_token', token); loginWithToken(token).then(() => nav('/')); }} />}
      </div>
    </AuthLayout>
  );
}
