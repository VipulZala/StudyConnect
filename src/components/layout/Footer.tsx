...
const Footer: React.FC = () => {
  return <footer className="bg-white dark:bg-gray-800 shadow-inner mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/connections" className="text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  Find Connections
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/study-room" className="text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  Virtual Study Rooms
                </Link>
              </li>
            </ul>
